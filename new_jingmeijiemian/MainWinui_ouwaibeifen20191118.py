...
class MainUi(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.right_layout.addWidget(self.right_bar_widget, 3, 0, 1, 9)#把搜索窗体加入网格布局的第二行，占据9行，索索窗体内部用的也是网格布局
        ...
        #self.right_recommend_layout.setContentsMargins(0,0,0,0)  #控件到布局线的距离为0
        ...
        #self.right_layout.addWidget(self.right_recommend_label,2, 0, 1,3,QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)  #装入网格布局
